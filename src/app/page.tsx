...
export default function Home() {
  return (
    <Container>
      ...
      <section id="benefits">
        <SectionTitle preTitle="L3 Squad Benefits" title="Why Should You Join This Community?">
      ...
      <section id="video">
        <SectionTitle preTitle="Watch a video" title="How to Get Started with Our Lifelong Learning Community">
      ...
      <section id="testimonials">
        <SectionTitle preTitle="Testimonials" title="Here's what our community said">
